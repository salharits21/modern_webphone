    ...
    try{
        window.onerror = function (msg, url, lineNo, columnNo, error)
        {
            try{
                if (console)
                {
                    msg = 'ERROR, GlobalErrorHandler catch: '+msg + ' (' + error + ') url: ' + url + ' line: ' + lineNo + ' col: ' + columnNo;
                    if (console.error)
                    {
                        console.error(msg);
                    }
                    ...
                    webphone_api.common.PutToDebugLog(2, 'ERROR, GlobalErrorHandler catch: ' + msg);
                }
            } catch(errin2) { ; }
            return false;
        };
...
//--}, 500);
    ...
    if (webphone_api.global.isdebugengine)
    {
        setTimeout(function ()
        {
            webphone_api.common.ChooseEngineLogic(1,function ()
            {
                console.log('StartUp');
            }, false, 5);
        },200);
...
//--     API_GuiStarted()  when skin is loaded
        ...
        {
            //GetParameterInt('isvideorecall', -1)
...
//type 1 = text box
    if (mSettType === '1')
    {
        ...
        var inputhtml = '<input type="text" id="setting_item_input" name="setting_item" data-theme="a" dir="auto" autocapitalize="off"/>';
        if (mCurrSettName === 'password')
        {
            ...
            */
            ...
            {
                inputhtml = '<input type="password" id="setting_item_input" name="setting_item" data-theme="a" dir="auto" autocapitalize="off" '+autocompleteflag+selectallflag+' ondblclick="ShowHidePwd()"/>';
            ...
            {
                inputhtml = '<input type="password" id="setting_item_input" name="setting_item" data-theme="a" dir="auto" autocapitalize="off" '+autocompleteflag+selectallflag+'/>';
            }
            else //if(autocompleteflag.length > 0)
            {
                inputhtml = '<input type="text" id="setting_item_input" name="setting_item" data-theme="a" dir="auto" autocapitalize="off" '+autocompleteflag+selectallflag+'/>';
            }
        }
...
'<div id="settings_type_4" data-role="popup" class="ui-content messagePopup" data-overlay-theme="a" data-theme="a" style="max-width:' + popupWidth + 'px;">' +
    ...
    '<div role="main" class="ui-content adialog_content">' +
        ...
        '<input type="text" id="setting_item_input" name="setting_item" data-theme="a" dir="auto" autocapitalize="off"/>' +
    '</div>' +
    '<div data-role="footer" data-theme="b" class="adialog_footer">' +
        '<a href="javascript:;" id="adialog_positive" class="ui-btn ui-corner-all ui-shadow ui-btn-inline ui-btn-b adialog_2button" data-rel="back" data-transition="flow">' + webphone_api.stringres.get('btn_ok') + '</a>' +
        '<a href="javascript:;" id="adialog_negative" class="ui-btn ui-corner-all ui-shadow ui-btn-inline ui-btn-b adialog_2button" data-rel="back">' + webphone_api.stringres.get('btn_cancel') + '</a>' +
...
'<div id="settings_type_server" data-role="popup" class="ui-content messagePopup" data-overlay-theme="a" data-theme="a" style="max-width:' + popupWidth + 'px;">' +
    ...
    '<div role="main" class="ui-content adialog_content adialog_btn_nexttoinput">' +
        ...
        '<input type="text" ' + widthclass + ' id="setting_item_input" name="setting_item" data-theme="a" dir="auto" autocapitalize="off"/>' +
...
'<div id="advancedsett_popup" data-role="popup" class="ui-content messagePopup" data-overlay-theme="a" data-theme="a" style="max-width:' + popupWidth + 'px;">' +
    ...
    '<div role="main" class="ui-content adialog_content">' +
        '<span>' + msg + '</span>' +
        '<div style="clear: both;"><!--//--></div>' +
        '<input type="text" id="advancedsett_input" name="setting_item" data-theme="a" dir="auto" autocapitalize="off"/>' +
    '</div>' +
    '<div data-role="footer" data-theme="b" class="adialog_footer">' +
        '<a href="javascript:;" id="adialog_positive" class="ui-btn ui-corner-all ui-shadow ui-btn-inline ui-btn-b adialog_2button" data-rel="back" data-transition="flow">' + webphone_api.stringres.get('btn_ok') + '</a>' +
        '<a href="javascript:;" id="adialog_negative" class="ui-btn ui-corner-all ui-shadow ui-btn-inline ui-btn-b adialog_2button" data-rel="back">' + webphone_api.stringres.get('btn_cancel') + '</a>' +
...
//you might use this function to set any extra parameters or callbacks here
function SetMyCallBacks()
{
    console.log('cccccc SetMyCallBacks');
    webphone_api.onAppStateChange (function (state)
    {
        console.log('cccccc webphone '+state);
        if (state === 'loaded') //webphone loaded
        {
            //we can begin to interact with the webphone API from here

            //set any extra parameters at runtime
            //webphone_api.setparameter('callforwardonbusy', '12345'); //this is just a parameter set example

            //set any custom callbacks here
            webphone_api.onCallStateChange(function (event, direction, peername, peerdisplayname, line, callid)
            {
                ...
                console.log('cccccc Call with '+peername+' '+event);
                if (event === 'connected')
                {
            ...
            webphone_api.onDTMF(function (dtmf, line)
            {
        ...
        {
            console.log('webphone started');
        }
        else if (appState === 'stopped')
        {
            console.log('webphone stopped');
        }
    });

...
function AddAccount(popupafterclose)
{
    ...
    if (webphone_api.common.ShowServerInput() === true)
    {
        ...
        '<input type="text" id="addacc_serveraddress" name="addacc_serveraddress" dir="auto" data-theme="a" autocapitalize="off" ' + val + ' placeholder="' + accounts_hint_server + '" />';
    }
...
'<div id="addaccountpopup" data-role="popup" class="ui-content messagePopup" data-overlay-theme="a" data-theme="a" style="max-width:' + popupWidth + 'px;">' +
    ...
    '<div role="main" class="ui-content adialog_content" style="margin-right: 1em;">' +
        ...
        '<input type="text" id="addacc_username" name="addacc_username" data-theme="a" dir="auto" autocapitalize="off" placeholder="' + accounts_hint_user+ '" />' +
        
        '<label for="addacc_password">' + webphone_api.stringres.get('addacc_password') + ':</label>'+
        '<input type="'+pwdinputtype+'" id="addacc_password" name="addacc_password" dir="auto" data-theme="a" autocapitalize="off" '+autocompleteflag+' placeholder="' + accounts_hint_password + '" />' +
        ...
        '<div id="addaccountpopup_advanced" style="display: none; margin-left: 2em;">' +
            ...
            '<input type="text" id="addacc_callerid" name="addacc_callerid" value="" dir="auto" data-theme="a" autocapitalize="off" placeholder="' + accounts_hint_callerid + '" />' +

            '<label for="addacc_displayname">' + webphone_api.stringres.get('sett_display_name_displayname') + ':</label>'+
            '<input type="text" id="addacc_displayname" name="addacc_displayname" value="" dir="auto" data-theme="a" autocapitalize="off" placeholder="' + accounts_hint_displayname + '" />' +

            '<label for="addacc_proxyaddress">' + webphone_api.stringres.get('sett_display_name_proxyaddress') + ':</label>'+
            '<input type="text" id="addacc_proxyaddress" name="addacc_proxyaddress" value="" dir="auto" data-theme="a" autocapitalize="off" placeholder="' + accounts_hint_proxy + '" />' +

            '<label for="addacc_realm">' + webphone_api.stringres.get('sett_display_name_realm') + ':</label>'+
            '<input type="text" id="addacc_realm" name="addacc_realm" value="" dir="auto" data-theme="a" autocapitalize="off" placeholder="' + accounts_hint_realm + '" />' +

            '<br /><label for="addacc_ival">' + webphone_api.stringres.get('addacc_ival') + ':</label>'+
            '<input type="text" id="addacc_ival" name="addacc_ival" value="3600" dir="auto" data-theme="a" autocapitalize="off" placeholder="' + accounts_hint_regival + '" />' +
        '</div>'+

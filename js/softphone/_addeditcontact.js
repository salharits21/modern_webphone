...
function onCreate (event) // called only once - bind events here
{
    ...
    webphone_api.$("#btn_revert_aec").on("click", function() { webphone_api.common.Back(true); }); //webphone_api.$.mobile.back();
...
//--             ranezni, hogy van-e benne space, s ha nincs akkor rakja be telefonszamnak
    ...
    try{ webphone_api.common.ShowToast(webphone_api.stringres.get('contact_save_error')); webphone_api.common.Back(true); } catch(err) { ; }
}
...
//--             ranezni, hogy van-e benne space, s ha nincs akkor rakja be telefonszamnak
    ...
    try{ webphone_api.common.ShowToast(webphone_api.stringres.get('contact_save_error')); webphone_api.common.Back(true); } catch(err2) { ; }
}

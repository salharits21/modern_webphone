...
'<div id="filter_popup" data-role="popup" class="ui-content messagePopup" data-overlay-theme="a" data-theme="a" style="width:' + popupWidth + 'px; max-width:' + popupWidth + 'px; min-width: ' + Math.floor(popupWidth * 0.6) + 'px;">' +
    ...
    '<div role="main" class="ui-content adialog_content" style="padding: 0; margin: 0; width: 100%;">' +
        ...
        '<div class="filter_right_container">' +
            '<input name="filter_what" id="filter_what" dir="auto" data-highlight="true" data-mini="true" value="' + fwhat_init + '" type="text" autocapitalize="off">' +
        '</div>' +
        ...
        '</div>' +
        '<div class="filter_right_container">' +
            '<input name="filter_with" id="filter_with" dir="auto" data-highlight="true" data-mini="true" value="' + fwith_init + '" type="text" autocapitalize="off">' +
        '</div>' +
        ...
        '</div>' +
        '<div class="filter_right_container">' +
            '<input name="filter_min" id="filter_min" dir="auto" data-highlight="true" data-mini="true" value="' + minl_init + '" type="text" autocapitalize="off">' +
        '</div>' +
        ...
        '</div>' +
        '<div class="filter_right_container">' +
            '<input name="filter_max" id="filter_max" dir="auto" data-highlight="true" data-mini="true" value="' + maxl_init + '" type="text" autocapitalize="off">' +
        '</div>' +

...
chrome_https: 'For modern browsers we recommend to host the webphone on secure http (https), otherwise WebRTC will not work. \n(This message appears only in the demo versions)',
webrtc_local_sipserver: 'Local WebRTC server required!',
chrome_https_reload: 'For modern browsers WebRTC will only work from secure http (https). \n(This message appears only in the demo versions) \n\n Click OK to reload the page using mizu https proxy.',
all_demo_msg: 'Note: these messages are displayed only in demo version. Licensed builds will try to handle these situations automatically with no messsage popups',
...
work_es: 'Trabajo',
webrtc_local_sipserver_es: '¡Se requiere un servidor WebRTC local!',
webcallme_msg_es: 'Envía este enlace a tus amigos y ellos podrán llamarte con un simple clic',
warning_notstarted_es: 'no se puede iniciar la llamada porque el teléfono aún no se inició',
warning_notreg_es: 'No se puede iniciar la llamada porque aún no se ha registrado',
warning_msg_4_es: 'Error al recuperar las configuraciones.<br>En la entrada del servidor de la página Configuración, ingrese el nombre de dominio o la dirección IP de su proveedor de VoIP',
warning_msg_3_es: 'Ingrese el nombre del contacto',
warning_msg_2_es: 'IP o nombre del dominio no soportado en esta versión. Introduzca nombre del servidor o ID aquí.',
warning_msg_1_es: 'Solo llamadas directas a SIP URIs son posibles si la dirección del servidor VoIP no está establecida',
warning_feature_es: 'debe obtener una licencia Pro para habilitar esta función.<br>Para activar la licencia, inicie sesión primero, luego seleccione "Licencia" en el menú.',
warning_es: 'Advertencia',
voicemail_title_es: 'Buzón voz',
voicemail_msg_es: 'Ingrese su número de correo de voz',
videomode__noask_es: 'Vuelva a llamar cuando sea necesario (no pregunte)',
videomode__disable_es: 'deshabilitar video entrante',
videomode__askonce_es: 'Vuelva a llamar cuando sea necesario (pregunte una vez)',
videomode__alwaysask_es: 'Vuelva a llamar cuando sea necesario (siempre pregunte)',
videomode__always_es: 'Siempre en modo video',
videocodec_optimal_es: 'Optimo',
video_rec_es: 'Cámara',
video_call_msg_es: 'Videollamada',
video_call_es: 'Videollamada',
video__force_es: 'Fuerza',
video__enable_es: 'habilitar',
video__disable_es: 'deshabilitar',
video__auto_es: 'Auto',
vcodec_optimal_es: 'Optimo',
username_warning2_es: 'la longitud mínima del nombre de usuario es 3.',
username_warning_es: 'ingrese el nombre de usuario SIP primero',
username_err_es: 'el nombre de usuario contiene caracteres especiales no admitidos, vuelva a escribir',
username_es: 'Usuario',
usenative_title_es: 'Usar aplicación nativa',
usenative_option_webrtc_es: 'ignorar e iniciar (webrtc) en el navegador web ahora mismo',
usenative_option_native_es: 'Recomendado: marcador nativo con mejor calidad',
use_stun__stable_nat_es: 'Solo con NAT estable',
use_stun__public_ip_es: 'Usar incluso en ip pública',
use_stun__no_es: 'No',
use_stun__force_es: 'Forzar IP privada',
use_stun__always_es: 'Siempre',
use_stun__all_symetric_es: 'Activo todos los NAT simétricos',
use_rport__simmetric_nat_es: 'Activo NAT simétrico',
use_rport__request_es: 'Solicitar pero no usar',
use_rport__public_ip_es: 'Incluso en ip pública',
use_rport__no_es: 'No',
use_rport__always_es: 'Siempre',
use_fast_ice__yes_es: 'Si',
use_fast_ice__no_es: 'No (establecido en 0 solo si su servidor necesita enrutar siempre los medios)',
use_fast_ice__auto_es: 'Auto',
use_fast_ice__always_es: 'Siempre (no recomendado)',
unmuted_video_es: 'Video no silenciado',
unmuted_es: 'Desactivar silencio',
unlockadvancedsett_title_es: 'configuración de desbloqueo',
unlockadvancedsett_msg_es: 'ingrese la contraseña para desbloquear la configuración avanzada',
type_work_es: 'Llamar al trabajo',
type_sip_es: 'Llamar a SIP URI',
type_phone_es: 'llamar al teléfono',
type_pager_es: 'Busca',
type_other_es: 'Llamar a otro',
type_mobile_es: 'Llamar a móvil',
type_home_es: 'Llamar a casa',
type_fax_work_es: 'Fax Trabajo',
type_fax_home_es: 'Fax Casa',
transfwithreplace__yes_es: 'Si',
transfwithreplace__no_es: 'No',
transfwithreplace__auto_es: 'Auto',
transfertype__withhold_es: 'Desatendido en espera',
transfertype__with_no_hold_es: 'transferencia sin retención ni desconexión',
transfertype__with_conf_es: 'Transferencia con conferencia',
transfertype__unattended_es: 'Colgado sin atender',
transfertype__auto_es: 'Auto',
transfertype__attanded_es: 'Atendido (primera llamada)',
transfer_title_es: 'Transferir llamada',
sync_title_es: 'sincronizar contactos',
sync_succeded_es: 'sincronización exitosa',
sync_msg_es: 'O Sincronizar contactos desde sus dispositivos móviles:',
sync_message_es: 'la sincronización solo funcionará después de que haya cargado los contactos desde el dispositivo móvil.',
sync_failed_es: 'error de sincronización',
sync_contacts_started_es: 'Sincronizando contactos...',
switch_engine_es: 'cambiar de motor',
switch_confmessage_es: 'para usar la conferencia, debe instalar NS -Service Plugin. Simplemente haga clic en Aceptar para continuar.',
switch_conf_title_es: 'Usar conferencia',
switch_conf_es: 'motor de conmutación para conferencias',
support_selectall_es: 'Seleccionar todo',
support_email_body_es: 'Copie y pegue aquí el contenido de la ventana de registro:',
status_startingengine_es: 'Inicio del motor de VoIP',
status_not_registered_es: 'No registrado',
status_enginestarted_es: 'motor de VoIP iniciado',
ssquality__medium_es: 'Medio',
ssquality__low_es: 'Bajo',
ssquality__high_es: 'Alto',
srvaddr_help_es: 'dirección del servidor del proveedor de servicios VoIP (dirección IP o nombre de dominio o registro DNS SRV). También puede agregar un número de puerto como sufijo si el servidor no está en el puerto SIP predeterminado (5060). Ejemplo: yourserver.com:6000<br>En caso de que sea nuevo en VoIP: a<br>diferencia de otros programas populares como Skype, si está utilizando el protocolo SIP estándar, puede utilizar cualquier proveedor de VoIP. Hay cientos de este tipo de servicios y también puede configurar su propio servidor, por ejemplo, utilizando el servidor Mizu o Asterisk.<br>Las llamadas internas (softphone a softphone) suelen ser gratuitas y el coste de las llamadas salientes (llamadas a móviles o fijos) suele ser más económico que el de los proveedores tradicionales, especialmente las llamadas internacionales.<br>También hay muchos otros beneficios en el uso de VoIP estándar, como alta calidad de llamada (con códec de banda ancha), libertad (puede cambiar su proveedor en cualquier momento), control (puede administrar fácilmente su cuenta) y flexibilidad (muchos servicios adicionales). servicios como grabación de llamadas, conferencias y otros). Incluso puede usar múltiples proveedores (por ejemplo, siempre puede usar el más barato para sus objetivos de llamada).<br>Si aún no tiene una cuenta de VoIP, puede crear una en unos minutos con cualquier proveedor y comenzar a usar VoIP ahora mismo: https://www.voip-info.org/wiki/view/Sip+Phone+ Servicios+Proveedores',
speakermode__never_es: 'Nunca',
speakermode__auto_es: 'Auto',
speakermode__always_es: 'Siempre',
speaker_on_es: 'Altavoz encendido',
speaker_off_es: 'Altavoz apagado',
smscodeverify_title_es: 'código de inicio de sesión',
smscode_instrucation_es: 'Debería recibir su código de inicio de sesión ahora por SMS. Por favor, introduzca su código de inicio de sesión:',
sms_verification_pwdmsg_es: 'Su contraseña es',
sms_verification_error1_es: 'código de inicio de sesión no válido',
sms_es: 'SMS',
sip_es: 'SIP URI',
silencesupress__yes_es: 'Si',
silencesupress__no_es: 'No',
silencesupress__auto_es: 'Auto',
show_search_es: 'Buscar en Configuración',
share_location__yes_es: 'Compartir',
share_location__no_es: 'No',
settings_title_all_es: 'Configuración',
settings_title_es: 'Configuración',
settings_login_es: 'Iniciar sesión',
sett_enabled_es: 'Habilitado',
sett_display_name_volumeout_es: 'Volumen de salida',
sett_display_name_volumein_es: 'Volumen de entrada',
sett_display_name_voicerecording_es: 'Grabación de llamadas',
sett_display_name_voicemailnum_es: 'Buzón voz',
sett_display_name_videomode_es: 'Vídeo entrante',
sett_display_name_videocodec_es: 'códec de vídeo',
sett_display_name_video_width_es: 'ancho de video',
sett_display_name_video_profile_es: 'Calidad del video',
sett_display_name_video_height_es: 'Altura del video',
sett_display_name_video_fps_es: 'Video FPS',
sett_display_name_video_bandwidth_es: 'Ancho de banda de video',
sett_display_name_video_es: 'Habilitar video',
sett_display_name_vibrate_es: 'Vibración',
sett_display_name_usetunneling_es: 'Tunneling y cifrado',
sett_display_name_useroutingapi_es: 'Utilice API de enrutamiento',
sett_display_name_username_es: 'Número llamante',
sett_display_name_use_vp9_es: 'usar el códec VP9',
sett_display_name_use_vp8_es: 'usar el códec VP8',
sett_display_name_use_stun_es: 'Utilizar STUN',
sett_display_name_use_rport_es: 'Uso de rport',
sett_display_name_use_h264_es: 'Utilizar codec H264',
sett_display_name_use_h263_es: 'Utilizar codec H263',
sett_display_name_use_fast_ice_es: 'Usar ICE',
sett_display_name_unlockphone_es: 'Desactivar el bloqueo de teclas',
sett_display_name_transport_es: 'Protocolo de transporte',
sett_display_name_transfwithreplace_es: 'Transferencia con reemplazo',
sett_display_name_transfertype_es: 'Tipo de transferencia',
sett_display_name_theme_es: 'Tema',
sett_display_name_textmessaging_es: 'Mensajería',
sett_display_name_telsearchkey_es: 'clave de búsqueda de teléfono',
sett_display_name_techprefix_es: 'Tecnología. prefijo',
sett_display_name_submenu_video_es: 'Video...',
sett_display_name_submenu_sounddevicevolume_es: 'Dispositivo de sonido y volumen...',
sett_display_name_submenu_sipsettings_es: 'Configuración SIP...',
sett_display_name_submenu_screenshare_es: 'Pantalla compartida...',
sett_display_name_submenu_profile_es: 'Mi perfil...',
sett_display_name_submenu_media_es: 'Configuración de medios...',
sett_display_name_submenu_integrate_es: 'Integración del marcador...',
sett_display_name_submenu_general_es: 'Configuración general...',
sett_display_name_submenu_calldivert_advanced_es: 'Configuración Avanzada...',
sett_display_name_submenu_calldivert_es: 'Configuración de desvío de llamadas...',
sett_display_name_submenu_advanced_es: 'Configuración Avanzada...',
sett_display_name_storecallhistory_es: 'almacenamiento del historial de llamadas',
sett_display_name_startwithos_es: 'Empezar con Windows',
sett_display_name_startonboot_es: 'Ejecutar en segundo plano',
sett_display_name_sstop_es: 'Arriba',
sett_display_name_ssscroll_es: 'Desplazarse',
sett_display_name_ssquality_es: 'Calidad',
sett_display_name_sscontrol_es: 'Controlar',
sett_display_name_speakerphoneplayer_es: 'Altavoz',
sett_display_name_speakerphoneoutput_es: 'Modo audio',
sett_display_name_speakermode_es: 'Modo altavoz',
sett_display_name_sms_es: 'URI SMS',
sett_display_name_sipusername_es: 'Usuario',
sett_display_name_silencesupress_es: 'Supresión de silencio',
sett_display_name_signalingport_es: 'Puerto local de señalización',
sett_display_name_share_location_es: 'Compartir mi ubicación',
sett_display_name_settobasefunctionality_es: 'Establecer como funcionalidad base',
sett_display_name_setqos_es: 'QoS',
sett_display_name_setfinalcodec_es: 'Establecer el codec final',
sett_display_name_serveraddress_user_es: 'Servidor',
sett_display_name_sendrtponmuted_es: 'Envío de audio en silencio',
sett_display_name_sendchatonenter_es: 'Chat al entrar',
sett_display_name_screenrotation_es: 'Rotación de pantalla',
sett_display_name_savetocontacts_es: 'Nuevo contacto',
sett_display_name_rtpport_es: 'Puerto local RTP',
sett_display_name_ringtone_es: 'Tono de llamada',
sett_display_name_ringtimeout_es: 'Caducidad del tono de llamada',
sett_display_name_reset_settings_es: 'Restaurar configuración',
sett_display_name_rejectonvoipbusy_es: 'VoIP ocupado',
sett_display_name_rejectonphonebusy_es: 'Teléfono ocupado',
sett_display_name_registerinterval_es: 'Intervalo de registro',
sett_display_name_register_es: 'Servidor de registro',
sett_display_name_realm_es: 'Reino',
sett_display_name_ratingrequest_es: 'Clasificación URI',
sett_display_name_proxyaddress_es: 'Dirección del proxy',
sett_display_name_proximitysensor_es: 'Sensor de proximidad',
sett_display_name_profilestatustext_es: 'Acerca de mí',
sett_display_name_profilepicture_es: 'foto de perfil',
sett_display_name_presencestatus_es: 'Estado de presencia',
sett_display_name_prack_es: 'Utilizar PRACK',
sett_display_name_plc_es: 'PLC',
sett_display_name_playring_es: 'Tono de llamada',
sett_display_name_password_es: 'Clave',
sett_display_name_p2p_es: 'URI para teléfono a teléfono',
sett_display_name_nsupgrademode_es: 'modo de actualización del motor NS',
sett_display_name_normalizenumber_es: 'Normalizar número',
sett_display_name_natopenpackets_es: 'Paquetes sobre NAT',
sett_display_name_nativefilterblock_es: 'Prefijos no gestionados',
sett_display_name_nativefilterallow_es: 'Prefijos gestionados',
sett_display_name_multiplecalls_es: 'Permitir múltiples llamadas',
sett_display_name_moresettings_es: 'Más configuraciones...',
sett_display_name_mediaencryption_es: 'Cifrado de medios',
sett_display_name_loglevel_dbg_es: 'Establecer el nivel de log/trazas',
sett_display_name_loglevel_es: 'Habilitar logs',
sett_display_name_localip_es: 'dirección IP local',
sett_display_name_language_es: 'Idioma',
sett_display_name_keeprecfiles_es: 'Guardar grabaciones para',
sett_display_name_keepdeviceawakeincall_es: 'Dispositivo preparado para la llamadas entrantes',
sett_display_name_keepaliveival_es: 'Conexión activa',
sett_display_name_keepalive_es: 'Conexión activa',
sett_display_name_jittersize_es: 'Duración del jitter',
sett_display_name_integrateifwifionly_es: 'Integrar solo en conexión Wifi',
sett_display_name_incomingcallpopup_es: 'ventana emergente de llamada entrante',
sett_display_name_incomingcallalert_es: 'Timbre',
sett_display_name_importonlywithnum_es: 'Importar solo con número',
sett_display_name_icetimeout_es: 'tiempo de espera de ICE',
sett_display_name_holdtype_es: 'tipo de retención',
sett_display_name_hidemyidentity_es: 'Ocultar mi identidad',
sett_display_name_hardwaremedia_es: 'recursos Hardware',
sett_display_name_forcewifi_es: 'Forzar WiFi',
sett_display_name_focusaudio_es: 'Priorizar audio',
sett_display_name_flash_es: 'Destello',
sett_display_name_filters_es: 'reescritura de números',
sett_display_name_extraoption_es: 'opciones adicionales',
sett_display_name_entersettings_es: 'Configuración...',
sett_display_name_enginepriority_webrtc_es: 'Prioridad WebRTC',
sett_display_name_enginepriority_p2p_es: 'prioridad P2P',
sett_display_name_enginepriority_ns_es: 'prioridad del complemento de servicio',
sett_display_name_enginepriority_nativedial_es: 'Prioridad de marcador nativo',
sett_display_name_enginepriority_java_es: 'prioridad del subprograma Java',
sett_display_name_enginepriority_flash_es: 'prioridad de flash',
sett_display_name_enginepriority_app_es: 'prioridad de la aplicación',
sett_display_name_enginepriority_accessnum_es: 'prioridad del número de acceso',
sett_display_name_encryptionport_es: 'Puerto de cifrado',
sett_display_name_enablepush_es: 'habilitar llamadas en segundo plano',
sett_display_name_enableblf_es: 'BLF',
sett_display_name_enableaudio_es: 'Habilitar audio',
sett_display_name_email_es: 'Email',
sett_display_name_earlymedia_es: 'Enviar audio anticipado',
sett_display_name_dtmfmode_es: 'DTMF',
sett_display_name_dropsameoldcall_es: 'soltar la misma llamada anterior',
sett_display_name_doublesendrtp_es: 'Envío doble RTP',
sett_display_name_displayvolumecontrols_es: 'mostrar siempre el volumen',
sett_display_name_displaynotification_es: 'Mostrar notificación',
sett_display_name_displayname_es: 'Nombre mostrado',
sett_display_name_displayaudiodevice_es: 'mostrar siempre el dispositivo de audio',
sett_display_name_disablewbforpstn_es: 'Desactivar banda ancha para PSTN',
sett_display_name_dialerintegration_es: 'Integrar',
sett_display_name_devtest_es: 'Test de desarrollador',
sett_display_name_denoise_es: 'Quitar ruido',
sett_display_name_defmute_es: 'Indicación de silencio',
sett_display_name_customsipheader_es: 'Cabecera SIP personalizada',
sett_display_name_creditrequest_es: 'Balanceo URI',
sett_display_name_cpualwayspartiallock_es: 'CPU siempre parcialmente bloqueado',
sett_display_name_conferencetype_es: 'tipo de conferencia',
sett_display_name_codecframecount_es: 'RTP Frame/Paquete',
sett_display_name_codec_es: 'Códec de audio',
sett_display_name_chatsms_es: 'Chat/SMS',
sett_display_name_changesptoring_es: 'Tono en progreso de sesión',
sett_display_name_cfgvideo_es: 'Habilitar video',
sett_display_name_cfgnetworkspeed_es: 'Velocidad de red',
sett_display_name_cfgcpuspeed_es: 'Velocidad de CPU',
sett_display_name_capabilityrequest_es: 'Solicitud de capacidad',
sett_display_name_calltransferalways_es: 'Transferir llamada',
sett_display_name_calltimeout_es: 'Caducidad de la llamada',
sett_display_name_callforwardonreject_es: 'Desvío de llamada al rechazar',
sett_display_name_callforwardonnoanswertimeout_es: 'Desvío de llamada sin tiempo de espera de respuesta',
sett_display_name_callforwardonnoanswer_es: 'Desvío de llamada sin respuesta',
sett_display_name_callforwardonbusy_es: 'Desviar llamada',
sett_display_name_callforwardalways_es: 'Desvío de llamadas siempre',
sett_display_name_callbacknumber_es: 'Número retorno de llamada (callback)',
sett_display_name_callback_mode_es: 'Modo rellamada',
sett_display_name_callback_accessnumber_es: 'Número retorno de llamada (callback)',
sett_display_name_callback_es: 'URI de devolución de llamada',
sett_display_name_call_access_es: 'Número de acceso en llamada',
sett_display_name_blacklist_es: 'Lista negra',
sett_display_name_beeponincoming_es: 'pitido',
sett_display_name_autousebluetooth_es: 'Bluetooth automático',
sett_display_name_automute_es: 'Silenciar nueva llamada',
sett_display_name_autoignore_es: 'Auto ignore',
sett_display_name_autohold_es: 'Nueva llamada en espera',
sett_display_name_autoanswer_forward_es: 'Auto-respuesta, reenvío o ignorar',
sett_display_name_autoaccept_es: 'Aceptación automática',
sett_display_name_audiorecorder_es: 'Grabación de audio',
sett_display_name_audioplayer_es: 'Reproductor de audio',
sett_display_name_audiodevices_es: 'Dispositivos de audio',
sett_display_name_audiobufferlength_es: 'Longitud del buffer de audio',
sett_display_name_audio_bandwidth_es: 'ancho de banda de audio',
sett_display_name_androidspeaker_es: 'altavoz de Android',
sett_display_name_alwaysallowlowcodec_es: 'Permitir códec de banda estrecha',
sett_display_name_agc_es: 'AGC',
sett_display_name_aec_es: 'AEC',
sett_display_name_advancedsettings_es: 'Configuración Avanzada...',
sett_display_name_advancedloginsettings2_es: 'Cuenta...',
sett_display_name_advancedloginsettings_es: 'Avanzado...',
sett_display_name_accounts_es: 'Cuentas',
sett_disabled_es: 'Deshabilitado',
sett_comment_volumeout_es: 'establece el volumen predeterminado del altavoz entre 0 y 100 %. 50 significa que no hay cambios de volumen.',
sett_comment_volumein_es: 'configura el volumen predeterminado del micrófono entre 0 y 100 %. 50 significa que no hay cambios de volumen.',
sett_comment_voicerecording_es: 'si está habilitado, todas las llamadas se grabarán',
sett_comment_voicemailnum_es: 'Establecer el número del buzón de voz que se utilizará si no se recibe automáticamente',
sett_comment_videomode_es: 'especifique cómo manejar las videollamadas entrantes',
sett_comment_videocodec_es: 'elija el códec de video preferido',
sett_comment_video_width_es: 'establece el ancho del video en píxeles',
sett_comment_video_profile_es: 'Establecer la calidad del video',
sett_comment_video_height_es: 'establece la altura del video en píxeles',
sett_comment_video_fps_es: 'Ajuste del número de imágenes por segundo en el video, 0 valor por defecto',
sett_comment_video_bandwidth_es: 'establece el ancho de banda del video',
sett_comment_video_es: 'Habilitar videollamada',
sett_comment_vibrate_es: 'Vibrar en las llamadas entrantes',
sett_comment_usetunneling_2_es: 'use señalización y medios dentro del túnel encriptado.',
sett_comment_usetunneling_1_es: 'Útil en países bloqueados de VoIP y detrás de firewalls. Si necesita usar esta función para más de unas pocas llamadas, debe actualizar a MizuDroidPro, que incluye un servicio de tunelización ilimitado.',
sett_comment_usetunneling_es: 'use una capa de transporte encriptada y tunelizada (UDP, TCP o HTTP)',
sett_comment_useroutingapi_es: 'Utilice el API de enrutamiento por razones de compatibilidad. Algunos dispositivos -por lo general viejos- podrían necesitar de esto para la correcta manipulación del audio',
sett_comment_username_es: 'esto no se usará para la autenticación. Especifique su ID de usuario o extensión aquí si no es el mismo que el nombre de usuario para la configuración de autenticación. ¡Algunos servidores VoIP rechazarán si no es lo mismo con el nombre de usuario!',
sett_comment_use_vp9_es: 'usar el códec de video VP9',
sett_comment_use_vp8_es: 'usar el códec de video VP8',
sett_comment_use_stun_es: 'Cambie si tiene problemas relacionados con NAT (no puede registrarse, no puede llamar, no tiene problemas de voz)',
sett_comment_use_rport_es: 'Utilizar Rport en la Cabecera',
sett_comment_use_h264_es: 'Utilizar codec de video H264',
sett_comment_use_h263_es: 'Utilizar codec de video H263',
sett_comment_use_fast_ice_es: 'Negociaciones ICE rápidas (para enrutamiento p2p rtp).<br>Nota: si se establece en "Auto" o "Sí", entonces STUN no debe desactivarse',
sett_comment_unlockphone_es: 'Desactiva automáticamente el bloqueo de teclas del teléfono durante una llamada entrante',
sett_comment_transport_es: 'Seleccionar capa de transporte',
sett_comment_transfwithreplace_es: 'especifique si se debe usar reemplazar con la transferencia para que la llamada anterior (diálogo) no se desconecte sino que simplemente se reemplace. De esta manera, la parte A nunca se desconecta, solo se cambia la parte llamada. La parte A debe poder manejar el encabezado de reemplazo para esto.',
sett_comment_transfertype_es: 'Elegir el tipo de transferencia de llamada',
sett_comment_theme_es: 'Cambiar colores de piel',
sett_comment_textmessaging_es: 'especificar el método de mensajería de texto',
sett_comment_telsearchkey_es: 'establecer la clave api de tel.search.ch',
sett_comment_techprefix_es: 'Añadir el prefijo a todos los números llamados',
sett_comment_submenu_video_es: 'Configuración relacionada con el video',
sett_comment_submenu_sounddevicevolume_es: 'Reproducción de sonido y grabación',
sett_comment_submenu_sipsettings_es: 'Configuración relacionada con el SIP',
sett_comment_submenu_screenshare_es: 'especificar la configuración del escritorio remoto',
sett_comment_submenu_profile_es: 'Configurar los detalles de mi perfil',
sett_comment_submenu_media_es: 'Codec de voz, calidad y dispositivo',
sett_comment_submenu_integrate_es: 'al marcar con un marcador nativo, se le preguntará si desea usar SIP o móvil',
sett_comment_submenu_general_es: 'Otras configuraciones',
sett_comment_submenu_calldivert_advanced_es: 'Más configuraciones',
sett_comment_submenu_calldivert_es: 'Desviar, transferir, rellamar',
sett_comment_submenu_advanced_es: 'Más configuraciones',
sett_comment_storecallhistory_es: 'Especifique dónde desea almacenar el histórico de llamadas',
sett_comment_startwithos_es: 'Iniciar cuando se inicia Windows',
sett_comment_startonboot_es: 'escuchar siempre las llamadas entrantes (el servicio se ejecutará en segundo plano para habilitar las llamadas entrantes)',
sett_comment_sstop_es: 'coloque la ventana para compartir pantalla en la parte superior',
sett_comment_ssscroll_es: 'Permitir controles de desplazamiento de ventana para compartir pantalla',
sett_comment_ssquality_es: 'calidad de escritorio remoto',
sett_comment_sscontrol_es: 'permite el control remoto para compartir la pantalla (de lo contrario, solo ver)',
sett_comment_speakerphoneplayer_es: 'Selecciona el canal de altavoz. Debería solo cambiarse en dispositivos especiales o si se tiene requerimientos especiales o si la configuración automática no es la elegida',
sett_comment_speakerphoneoutput_es: 'Selecciona el dispositivo de salida cuando se conmuta al altavoz',
sett_comment_speakermode_es: 'Modo altavoz',
sett_comment_sms_es: 'Petición HTTP SMS',
sett_comment_sipusername_es: 'Su usuario SIP usado para autenticación',
sett_comment_silencesupress_es: 'no transmita contenido multimedia cuando no hable. Habilite solo si su ancho de banda es realmente bajo.',
sett_comment_signalingport_es: 'especifique el puerto de señalización de la dirección IP local que se usará (el valor predeterminado es un puerto estable inicializado con un valor aleatorio. Esto no tiene nada que ver con el puerto SIP del servidor, que generalmente es 5060)',
sett_comment_short_voicemailnum_es: 'Establecer el número de acceso al buzón de voz',
sett_comment_short_video_bandwidth_es: 'establece el ancho de banda del video',
sett_comment_short_usetunneling_es: 'Usa transporte cifrado alternativo',
sett_comment_short_username_es: 'puede configurar un nombre de usuario diferente aquí para mostrar un número',
sett_comment_short_use_stun_es: 'Permitir el descubrimiento externo de direcciones',
sett_comment_short_transport_es: 'Seleccionar capa de transporte',
sett_comment_short_transfwithreplace_es: 'especifique si se debe usar reemplazar con la transferencia para que la llamada anterior (diálogo) no se desconecte sino que simplemente se reemplace.',
sett_comment_short_sms_es: 'En caso de servidor HTTP API',
sett_comment_short_sipusername_es: 'nombre de usuario de la cuenta VoIP',
sett_comment_short_signalingport_es: 'opcionalmente, especifique el puerto de señalización local para usar',
sett_comment_short_serveraddress_user_es: 'dirección del servidor VoIP',
sett_comment_short_screenrotation_es: 'Controla la orientación de la pantalla',
sett_comment_short_savetocontacts_es: 'Añadir nuevo contacto a la lista de contactos',
sett_comment_short_rtpport_es: 'Especificar puerto RTP local',
sett_comment_short_registerinterval_es: '(Re)registrar intervalo de tiempo en segundos',
sett_comment_short_register_es: 'Habilitar / Deshabilitar el registro contra el dominio SIP',
sett_comment_short_realm_es: 'establezca el dominio SIP si la detección automática predeterminada no es correcta',
sett_comment_short_ratingrequest_es: 'En caso de servidor HTTP API',
sett_comment_short_proxyaddress_es: 'Dirección del proxy saliente',
sett_comment_short_proximitysensor_es: 'Desconecta la pantalla cuando se acerca la oreja',
sett_comment_short_password_es: 'contraseña de la cuenta de VoIP',
sett_comment_short_p2p_es: 'En caso de servidor HTTP API',
sett_comment_short_keepaliveival_es: 'Mantiene abierto el NAT',
sett_comment_short_keepalive_es: 'Mantiene abierto el NAT',
sett_comment_short_hardwaremedia_es: 'Usar mejoras de medios de hardware.',
sett_comment_short_forcewifi_es: 'Mantiene el WiFi levantado para gestionar llamadas entrantes',
sett_comment_short_focusaudio_es: 'Priorizar el audio en llamadas VoIP',
sett_comment_short_extraoption_es: 'establezca cualquier parámetro personalizado',
sett_comment_short_email_es: 'Dirección de correo electrónico',
sett_comment_short_doublesendrtp_es: 'Envío doble de paquetes RTP',
sett_comment_short_displaynotification_es: 'Muestra notificaciones en la barra de notificaciones del teléfono',
sett_comment_short_displayname_es: 'Establecer nombre para mostrar',
sett_comment_short_creditrequest_es: 'En caso de servidor HTTP API',
sett_comment_short_cpualwayspartiallock_es: 'Mantiene un bloqueo parcial en la CPU para prevenir hibernación.',
sett_comment_short_codecframecount_es: 'Carga útil de codec en un paquete UDP.',
sett_comment_short_changesptoring_es: 'Trata la respuesta de progreso de sesión (183) como tono de llamada (180)',
sett_comment_short_cfgcpuspeed_es: 'Las características se selecciona automáticamente basándose en la velocidad de CPU',
sett_comment_short_callforwardonreject_es: 'Desvío de llamadas en caso de rechazo',
sett_comment_short_callbacknumber_es: 'Número de teléfono de retorno de llamada (callback)',
sett_comment_short_callback_es: 'En caso de servidor HTTP API',
sett_comment_short_call_access_es: 'Número de acceso para llamar desde la red de operador móvil',
sett_comment_short_audiobufferlength_es: 'Ajuste avanzado para el tamaño del buffer de reproducción de audio',
sett_comment_share_location_es: 'compartir los detalles de mi ubicación con los contactos.',
sett_comment_settobasefunctionality_es: 'Utilizada en desarrollo',
sett_comment_setqos_es: 'Establece la clase de tráfico o octeto de tipo de servicio en las cabeceras IP para paquetes UDP',
sett_comment_setfinalcodec_es: 'Solución para la negociación con múltiples codecs',
sett_comment_serveraddress_user_operator_es: 'Introduzca el código de operador',
sett_comment_serveraddress_user_gmsdialer_es: 'Introduzca el código de operador',
sett_comment_serveraddress_user_es: 'Ingrese la dirección del servidor (dominio o IP: puerto), nombre de marca o código de operación aquí',
sett_comment_sendrtponmuted_es: 'Envía RTP incluso en silencio activado (paquetes puestos a cero). Establece verdadero solo si el servidor funciona mal cuando se suprime RTP',
sett_comment_sendchatonenter_es: 'enviar chat al presionar la tecla Intro',
sett_comment_screenrotation_es: 'Controla la orientación de la pantalla',
sett_comment_savetocontacts_es: 'Para añadir un número llamado a su lista de contactos',
sett_comment_rtpport_es: 'Especificar el puerto local RTP base (por defecto es un puerto base constante inicializado con un valor aleatorio)',
sett_comment_ringtone_es: 'Cambia el tono de llamada para llamadas entrantes',
sett_comment_ringtimeout_es: 'Tiempo máximo permitido en segundos que sonará el tono de llamada. Por defecto 90 segundos.',
sett_comment_reset_settings_es: 'Restaura la configuración a los valores por defecto',
sett_comment_rejectonvoipbusy_es: 'Establece el comportamiento si hay todavía una llamada VoIP en progreso',
sett_comment_rejectonphonebusy_es: 'establezca el comportamiento si ya hay una llamada telefónica nativa en curso',
sett_comment_registerinterval_es: '(Re)registrar intervalo de tiempo en segundos',
sett_comment_register_es: 'Registro de dominio. Esto siempre es necesario para recibir llamadas entrantes y algunos proveedores requieren también permitir llamadas salientes.',
sett_comment_realm_es: 'establezca el reino SIP si no es el mismo con la dirección del servidor o el dominio',
sett_comment_ratingrequest_es: 'Petición de clasificación HTTP',
sett_comment_proxyaddress_es: 'dirección de proxy SIP saliente. Déjalo vacío si no tienes un proxy sin estado/de salida',
sett_comment_proximitysensor_es: 'Desconecta la pantalla durante la llamada. Esta característica se desconecta por defecto porque la mayor parte de los dispositivos tienen problemas para conectar',
sett_comment_profilestatustext_es: 'puede ingresar cualquier texto aquí (por ejemplo, enlace a su página de Facebook).',
sett_comment_profilepicture_es: 'configura tu foto de perfil.',
sett_comment_presencestatus_es: 'Cambiar mi estado de presencia.',
sett_comment_prack_es: 'Soporte para paquetes 100rel. Debe ser habilitado sólo si el servidor así lo requiere',
sett_comment_plc_es: 'Ocultación de pérdida de paquetes. Ayuda a mejorar la calidad de la llamada causada por pérdida de paquetes en redes de baja calidad',
sett_comment_playring_es: 'Generar el tono de llamada para las llamadas entrantes y salientes',
sett_comment_password_es: 'Introducir la contraseña de su cuenta SIP',
sett_comment_p2p_es: 'Petición http teléfono a teléfono',
sett_comment_nsupgrademode_es: 'establece cómo/cuándo actualizar el motor NS.',
sett_comment_normalizenumber_es: 'eliminar caracteres especiales de los números marcados',
sett_comment_natopenpackets_es: 'Paquetes UDP enviado a un dispositivo NAT(cambiar si tiene problemas con la NAT)',
sett_comment_nativefilterblock_es: 'No gestiona las llamadas nativas si el número empieza con',
sett_comment_nativefilterallow_es: 'Gestiona las llamadas nativas si el número empieza con',
sett_comment_multiplecalls_es: 'Permitir múltiples llamadas / conferencias (CPU de gama baja no es capaz gestionarlas)',
sett_comment_moresettings_es: 'Mostrar más configuraciones',
sett_comment_mediaencryption_es: 'establecer el método de cifrado de medios',
sett_comment_loglevel_dbg_es: 'Establece el nivel de detalle de logs cuando las trazas están activadas',
sett_comment_loglevel_es: 'Guarda las trazas en un fichero para enviarlo al soporte técnico',
sett_comment_localip_es: 'Opcionalmente, especifique la dirección IP de señalización local para usar',
sett_comment_language_es: 'establecer el idioma de la aplicación',
sett_comment_keeprecfiles_es: 'mantener grabaciones de llamadas de los últimos días especificados',
sett_comment_keepdeviceawakeincall_es: 'Dispositivo operativo durante las llamadas',
sett_comment_keepaliveival_es: 'intervalo de envío de paquetes NAT keep-alive en milisegundos. Establecer en 0 para deshabilitar.',
sett_comment_keepalive_es: 'enviará un paquete corto en el intervalo de tiempo especificado (segundos) para abrir y mantener abierto su dispositivo NAT (enrutador) para habilitar las llamadas entrantes y otras notificaciones',
sett_comment_jittersize_es: 'El buffer jitter se usa para una reproducción suave con ancho de banda variable.  El tamaño se calcula dinámicamente, pero su comportamiento se puede modificar con este ajuste',
sett_comment_integrateifwifionly_es: 'Integrar con el marcador nativo solo en conexiones Wifi',
sett_comment_incomingcallpopup_es: 'si mostrar una ventana emergente sobre las llamadas entrantes.',
sett_comment_incomingcallalert_es: 'Selecciona el canal de reproducción del timbre. Debería solo cambiarse en dispositivos especiales o si se tiene requerimientos especiales o si la configuración automática no es la elegida',
sett_comment_importonlywithnum_es: 'si está marcado, omitirá los contactos sin un número de teléfono',
sett_comment_icetimeout_es: 'establece el tiempo de espera de ICE en milisegundos',
sett_comment_holdtype_es: 'especifique cómo retener llamadas',
sett_comment_hidemyidentity_es: 'ocultar identificador de llamadas',
sett_comment_hardwaremedia_es: 'Utilizar las mejoras de los recursos hardware para AEC o eliminar el ruido. Esto puede añadir un ligero retardo para las transmisiones de audio',
sett_comment_forcewifi_es: '(Re)Activa y escanea WiFi en el arranque, nueva llamada o pérdida de conexión(Incluso sin esta configuración, WiFi será el preferido cuando esté disponible)',
sett_comment_focusaudio_es: 'Prioriza el audio de la llamada VoIP(esto podría reducir el volumen de otros flujos de audio, mientras que está hablando sobre VoIP)',
sett_comment_flash_es: 'Flash en llamada entrante o chat',
sett_comment_filters_es: 'Agregar reglas de reescritura de número de destino (agregar/eliminar/reescribir prefijo)',
sett_comment_extraoption_es: 'establezca cualquier parámetro personalizado en una lista de pares clave-valor, separados por punto y coma.<br>Ej: nombre para mostrar = John;',
sett_comment_entersettings_es: 'Mostrar configuración',
sett_comment_enginepriority_webrtc_es: 'establecer la prioridad del motor WebRTC',
sett_comment_enginepriority_p2p_es: 'establece la prioridad del motor de teléfono a teléfono',
sett_comment_enginepriority_ns_es: 'establecer la prioridad del motor del complemento de servicio',
sett_comment_enginepriority_nativedial_es: 'establecer la prioridad del motor de marcador nativo',
sett_comment_enginepriority_java_es: 'establecer la prioridad del motor del applet de Java',
sett_comment_enginepriority_flash_es: 'establecer la prioridad del motor flash',
sett_comment_enginepriority_app_es: 'establecer la prioridad del motor de la aplicación',
sett_comment_enginepriority_accessnum_es: 'establecer la prioridad del motor del número de acceso',
sett_comment_encryptionport_es: 'Puerto base del servidor utilizado para transporte cifrado',
sett_comment_enablepush_es: 'Escuche las llamadas entrantes también cuando el teléfono web no está abierto',
sett_comment_enableblf_es: 'campo de luz de ocupado',
sett_comment_enableaudio_es: 'Utilizada únicamente en pruebas',
sett_comment_email_es: 'Dirección de correo electrónico (útil para soporte técnico)',
sett_comment_earlymedia_es: 'Comenzar a enviar audio una vez se recibe session progress',
sett_comment_dtmfmode_es: 'Elegir DTMF (marcación por tonos) como método de envío',
sett_comment_dropsameoldcall_es: 'Desconectar la llamada si se recibe la misma llamada varias veces',
sett_comment_doublesendrtp_es: 'Podría mejorar la calidad de audio en algunas circunstancias, pero incrementará  la cantidad de datos enviada',
sett_comment_displayvolumecontrols_es: 'mostrar siempre los controles de volumen durante una llamada',
sett_comment_displaynotification_es: 'Muestra notificaciones en la barra de notificaciones del teléfono (normalmente en la esquina superior del teléfono)',
sett_comment_displayname_es: 'especifique el nombre para mostrar. Esta es una configuración opcional y debe ser su nombre completo',
sett_comment_displayaudiodevice_es: 'mostrar siempre el dispositivo de audio durante una llamada',
sett_comment_disablewbforpstn_es: 'Desactivar codecs de audio de banda ancha para llamadas a números móviles y fijos (banda ancha solo para llamadas de IP a IP)',
sett_comment_dialerintegration_es: 'al marcar con un marcador nativo, se le preguntará si desea usar SIP o móvil',
sett_comment_devtest_es: 'Usado solo para desarrollo',
sett_comment_denoise_es: 'elimina el ruido de la conversación (como el ruido de fondo o el ruido generado por el micrófono).',
sett_comment_defmute_es: 'Especifica como silenciar las llamadas cuando se presiona el botón de silencio',
sett_comment_customsipheader_es: 'Establece una cabecera SIP personalizada (una línea en la señalización SIP) que será enviada con todos los mensajes SIP (configuración avanzada)',
sett_comment_creditrequest_es: 'Petición de balanceo HTTP',
sett_comment_cpualwayspartiallock_es: 'Mantiene el procesador del dispositivo siempre levantado. Configurarlo solo si de otra forma se pierde los registros y no se reciben llamadas entrantes',
sett_comment_conferencetype_es: 'habilitar/deshabilitar la función de sala de conferencias',
sett_comment_codecframecount_es: 'número de cargas útiles de códec en un paquete UDP/RTP. Los valores más altos requerirán menos ancho de banda pero más retrasos. Valores inusuales (por encima de 4) pueden causar incompatibilidad con su proveedor.',
sett_comment_codec_es: 'Seleccione el códec preferido',
sett_comment_chatsms_es: 'Establece el método de mensajería',
sett_comment_changesptoring_es: 'Trata la respuesta de progreso de sesión (183) como tono de llamada (180). Esto se podría requerir si el proveedor de servicio no envía tono de llamada ni audio',
sett_comment_cfgvideo_es: 'Habilitar videollamada',
sett_comment_cfgnetworkspeed_es: 'ayuda a elegir el mejor códec y mejoras multimedia para sus llamadas.',
sett_comment_cfgcpuspeed_es: 'Características como AEC o codec se activan/desactivan en base a la velocidad de procesador del dispositivo',
sett_comment_capabilityrequest_es: 'Si se establece, enviará un mensaje de solicitud de capacidad (OPTIONS) al servidor SIP en el arranque',
sett_comment_calltransferalways_es: 'establezca el número de transferencia de llamadas donde se deben transferir todas las llamadas',
sett_comment_calltimeout_es: 'tiempo máximo de conversación permitido en segundos. El valor predeterminado es 10800 segundos, lo que significa 3 horas',
sett_comment_callforwardonreject_es: 'Reenviar llamada si es rechazada',
sett_comment_callforwardonnoanswertimeout_es: 'demora en segundos antes de que la llamada se desvíe si no responde',
sett_comment_callforwardonnoanswer_es: 'establecer el número de desvío de llamadas, las llamadas deben desviarse si no hay respuesta',
sett_comment_callforwardonbusy_es: 'establece el número de desvío de llamadas utilizado cuando la llamada se rechaza por ocupado o para el desvío automático',
sett_comment_callforwardalways_es: 'establece el número de desvío de llamadas al que se deben desviar todas las llamadas',
sett_comment_callbacknumber_es: 'Número de teléfono de retorno de llamada (callback). Algunos proveedores de servicio VoIP ofrecen este número al que se puede llamar, para recibir llamadas desde el servidor IVR',
sett_comment_callback_mode_es: 'Selecciona cuando usar el modo rellamada',
sett_comment_callback_accessnumber_es: 'Número de teléfono de retorno de llamada (callback). Algunos proveedores de servicio VoIP ofrecen este número al que se puede llamar, para recibir llamadas desde el servidor IVR',
sett_comment_callback_es: 'Petición HTTP de devolución de llamada',
sett_comment_call_access_es: 'Número de acceso de IVR para llamar desde la red de operador móvil',
sett_comment_blacklist_es: 'Números en la lista negra separados por coma',
sett_comment_beeponincoming_es: 'pitido en llamada entrante o chat',
sett_comment_autousebluetooth_es: 'Uso Bluetooth automáticamente cuando detecte dispositivos',
sett_comment_automute_es: 'Especifica que las nuevas llamadas deben ser silenciadas si hay otras llamadas',
sett_comment_autoignore_es: 'Ignora automáticamente todas las llamadas entrantes',
sett_comment_autohold_es: 'Especifica que las nuevas llamadas deben quedar en espera si existen llamadas',
sett_comment_autoanswer_forward_es: 'Encargarse automáticamente de TODAS las llamadas entrantes',
sett_comment_autoaccept_es: 'aceptar automáticamente todas las llamadas entrantes (respuesta automática)',
sett_comment_audiorecorder_es: 'Selecciona el canal de grabación de audio para las llamadas. Debería solo cambiarse en dispositivos especiales o si se tiene requerimientos especiales o si la configuración automática no es la elegida',
sett_comment_audioplayer_es: 'Selecciona el canal de reproducción de audio para llamadas. Debería solo cambiarse en dispositivos especiales o si se tiene requerimientos especiales o si la configuración automática no es la elegida',
sett_comment_audiodevices_es: 'la configuración del dispositivo de audio estará disponible en el menú de la página del teclado una vez que inicie sesión',
sett_comment_audiobufferlength_es: '-1 significa automático. Los valores válidos están entre 160 y 16000. Configuración experta.',
sett_comment_audio_bandwidth_es: 'establecer el ancho de banda de audio',
sett_comment_androidspeaker_es: 'especifique el dispositivo de reproducción predeterminado en Android',
sett_comment_alwaysallowlowcodec_es: 'habilitar siempre el códec básico de banda estrecha',
sett_comment_agc_es: 'Control automático de ganancia. Controlará el volumen automáticamente.',
sett_comment_aec_es: 'cancelación de eco acústico. Actívelo si sus compañeros escuchan su eco.',
sett_comment_advancedsettings_es: 'Mostrar opciones Avanzadas de Configuración',
sett_comment_advancedloginsettings2_es: 'configuración relacionada con el inicio de sesión SIP',
sett_comment_advancedloginsettings_es: 'muestra la configuración de inicio de sesión avanzada',
sett_comment_accounts_es: 'Administre múltiples cuentas SIP. ¡Use esto solo si desea configurar más de una cuenta!',
sett_chooseengine_title_es: 'motor VoIP',
sett_chooseengine_popup_title_es: 'motores disponibles',
sett_chooseengine_comment_es: 'Seleccionar motor VoIP',
sett_checkbox_videocodec_es: 'usar solo el códec de video preferido',
sett_checkbox_codec_es: 'Utilizar solamente el códec preferido',
sett_ce_recommended_es: 'recomendado',
sett_ce_highly_es: 'muy recomendable',
setqos__yes_es: 'Si',
setqos__no_es: 'No',
setqos__auto_es: 'Auto',
setfinalcodec__never_es: 'Nunca',
setfinalcodec__multiple_codec_es: 'Activo codificador múltiple',
setfinalcodec__auto_es: 'Auto',
setfinalcodec__always_es: 'Siempre',
serviceengine_title_es: 'Usar complemento de servicio',
serviceengine_msg_es: 'instale el complemento de servicio para una mejor experiencia',
service_update_es: 'una nueva versión del motor NS VoIP está disponible. <br>Descargue e inicie el ejecutable para actualizar.',
sendtosupport_es: 'Enviar a soporte',
send_msg_es: 'Enviar mensaje',
send_dtmf_es: 'Enviar DTMF',
screenshare_call_es: 'Compartir pantalla',
savetocontacts__yes_es: 'Si (No preguntar por nombre del contacto)',
savetocontacts__no_es: 'No',
savetocontacts__ask_es: 'Preguntar',
save_to_contacts_title_es: 'Guardar en contactos',
save_to_contacts_msg_es: '¿Guardar este número como contacto?',
reset_settings_msg2_es: 'la configuración se restableció a los valores predeterminados.',
reset_settings_msg_es: '¿Seguro que quiere restablecer la configuración?',
request_permission2_title_es: 'Permitir permiso',
request_permission2_es: 'permite que [BRANDNAME] use su micrófono y/o cámara. <br>Es posible que haya bloqueado antes el acceso a los dispositivos de micrófono y/o cámara. En este caso, vaya a la configuración de su navegador y habilite el acceso para este dominio.',
request_permission_es: 'Esperando permiso. Presione el botón Permitir/Compartir en su navegador. Haga clic en el icono webrtc/micrófono/cámara/rojo si no ve el cuadro de diálogo.',
register__yes_es: 'Si',
register__no_es: 'No',
register__auto_es: 'Invitado automático',
recharge_msg_es: 'Tarjeta de recarga (código PIN)',
recharge_error_es: 'Ingrese su código PIN de recarga',
recharge_es: 'Recarga de Crédito',
rating_minute_es: '\\ min',
quicktransf_hint_es: 'transferencia desatendida',
quickcall_title_es: 'llamada rápida',
quickcall_msg_es: 'Ingrese el número de teléfono para llamar',
proversion_content_text_es: 'actualice a la versión Pro para uso comercial y funciones adicionales como el códec G.729 y otros.',
presence_title_es: 'Establecer estado de presencia',
presence_stat_online_es: 'en línea',
presence_stat_offline_es: 'Desconectado',
presence_stat_invisible_es: 'Invisible',
presence_stat_dnd_es: 'No molestar',
presence_stat_away_es: 'Ausente',
ppupload_failed_es: '¡Elige una imagen para enviar primero!',
pp_msg_es: 'elegir foto de perfil',
please_enter_es: 'Por favor introduzca',
plc__yes_es: 'Si',
plc__no_es: 'No',
plc__auto_es: 'Automático',
playring__no_es: 'No',
playring__incoming_es: 'para llamadas entrantes',
playring__both_es: 'para llamadas entrantes y salientes',
pick_ct_es: 'Seleccionar contacto',
phone_nr2_es: 'Número Telefónico',
phone_nr_es: 'Nr Teléfono',
phone_es: 'Teléfono',
password_warning2_es: 'la longitud mínima de la contraseña es 3.',
password_err_es: 'la contraseña contiene caracteres especiales no admitidos, vuelva a escribir',
password_es: 'Clave',
pager_es: 'Busca',
p2p_nrb_es: 'A quien llamas',
p2p_nra_es: 'Tu número de teléfono',
p2p_err2_es: 'Introduzca el número de destino',
p2p_err1_es: 'Ingrese su número',
p2p_es: 'Teléfono a Teléfono',
other_es: 'Otro',
only_webrtc_engine2_es: 'solo el motor WebRTC está disponible en su navegador, pero está deshabilitado en el teléfono web. Póngase en contacto con su proveedor de servicios.',
only_webrtc_engine1_es: 'solo el motor WebRTC está disponible en su navegador, pero está deshabilitado en el teléfono web con el parámetro enginepriority_webrtc',
only_ns_engine4_es: 'solo el motor Java VoIP está habilitado, pero no está disponible en su navegador. Utilice un navegador compatible con el applet de Java.',
only_ns_engine3_es: 'solo el motor Java VoIP está habilitado, pero no está disponible en su navegador. Utilice un navegador compatible con el subprograma Java, como Internet Explorer.',
only_ns_engine2_es: 'solo el motor de complemento de servicio está disponible en su navegador, pero está deshabilitado en el teléfono web. Póngase en contacto con su proveedor de servicios.',
only_ns_engine1_es: 'solo el motor del complemento de servicio está disponible en su navegador, pero está deshabilitado en el teléfono web con el parámetro enginepriority_ns',
only_app_engine2_es: 'solo el motor de la aplicación está disponible en su navegador, pero está deshabilitado en el teléfono web. Póngase en contacto con su proveedor de servicios.',
only_app_engine1_es: 'solo el motor de la aplicación está disponible en su navegador, pero está deshabilitado en el teléfono web con el parámetro enginepriority_app',
on_hold_es: 'En Espera',
nu_username_es: 'Usuario',
nu_phone_es: 'Teléfono',
nu_password_verify_es: 'Verificar contraseña',
nu_password_es: 'Clave',
nu_lastname_es: 'Apellido',
nu_gender_es: 'Género',
nu_fullname_es: 'Nombre completo',
nu_fpq_es: 'Pregunta de contraseña olvidada',
nu_fpa_es: 'respuesta de contraseña olvidada',
nu_firstname_es: 'Nombre',
nu_email_es: 'Dirección email',
nu_country_es: 'País',
nu_birthday_es: 'Cumpleaños',
nu_address_es: 'Dirección',
nsupgrademode__immediate_es: 'instalación inmediata',
nsupgrademode__delayed_es: 'Antecedentes o solicitar usuario',
nsupgrademode__background_es: 'solo instalación en segundo plano retrasada',
ns_engine_unreachable_es: 'motor inaccesible.',
np_successfully_installed_es: 'el complemento de servicio se instaló correctamente.',
np_popup_title_es: 'Complemento de servicio',
np_popup_msg_es: 'debe instalar el complemento de servicio para que funcione el softphone.',
np_install_why_es: '¿Por qué veo esto?',
np_install_warn_es: '¡Complemento de servicio no accesible!',
np_install_title_es: 'Complemento de servicio',
np_install_msg_mac_es: 'extraiga e instale la aplicación.',
np_install_msg_lin_es: 'descargue, extraiga (descomprima) y ejecute el instalador <br>(puede iniciar el archivo .run desde la consola de su terminal).',
np_install_msg_es: 'Inicie el instalador una vez descargado. <br>Haga clic en Aceptar cuando finalice la instalación.',
np_download_es: 'descarga del complemento de servicio',
notification_message_es: 'Llamada entrante de',
not_panel_title_es: 'Notificaciones',
not_missed_chat_es: 'chat perdido de',
not_missed_call_es: 'Llamada perdida de',
normalizenumber__yes_es: 'Si',
normalizenumber__no_es: 'No',
normalizenumber__auto_es: 'Auto',
noaccounts_es: 'Sin cuentas. Haga clic en el botón Más para agregar cuentas',
no_history_es: 'Historial de Llamadas Vacío.',
no_contacts_2_es: 'O use la opción de menú "Sincronizar contacto" para importar contactos desde su teléfono móvil.<br>(La sincronización funcionará solo después de cargar los contactos desde el dispositivo móvil)',
no_contacts_1_es: 'para crear contactos, seleccione "Nuevo contacto" en el menú.',
newuser_title_es: 'Nuevo usuario',
newuser_pleaseenter_es: 'Por favor introduzca',
newuser_invalid_es: 'no válido',
newuser_a_es: 'Crear una cuenta',
newuser_es: 'Nuevo usuario',
nativeplugin_es: 'Complemento de servicio',
native_call_es: 'Iniciando llamada nativa...',
name_es: 'Nombre',
myprovider_es: 'Casa',
myaccount_es: 'Mi cuenta',
muted_video_es: 'Video silenciado',
muted_es: 'Silenciado',
msglist_title_es: 'Mensajes',
msg_title_sms_es: 'SMS',
msg_title_chat_es: 'Mensaje de Chat',
mobile_es: 'Móvil',
messages_es: 'nuevos mensajes',
messagepl_es: 'Redactar',
messagehistory_es: 'Mensajes',
message_sent_es: 'Enviar mensaje.',
message_from_es: 'Mensaje de',
menu_webcallme_es: 'Mi URL de click2call',
menu_volumeshow_es: 'controles de volumen',
menu_volumehide_es: 'Ocultar controles de volumen',
menu_videorecall_es: 'Recuperación de video',
menu_unblock_contact_es: 'Desbloquear contacto',
menu_transfer_es: 'transferir',
menu_sync_es: 'Importar contactos desde Android',
menu_switchtobasic_es: 'Mostrar Opciones Básicas de Configuración',
menu_switchtoadvanced_es: 'Mostrar opciones Avanzadas de Configuración',
menu_stop_record_call_es: 'detener la grabación de llamadas',
menu_speedtest_es: 'prueba de velocidad',
menu_speaker_es: 'Altavoz',
menu_sortct_es: 'Ordenar contactos',
menu_showsettings_es: 'Configuración',
menu_showlogs_es: 'Mostrar registros',
menu_screenshare_es: 'Compartir pantalla',
menu_record_call_es: 'Grabar llamada',
menu_reconnect_es: 'Volver a Conectar',
menu_qrcode_es: 'código QR',
menu_popup_es: 'ventana emergente',
menu_paste_es: 'Pegar',
menu_open_es: 'Abierto',
menu_numpad_hide_es: 'Ocultar teclado numérico',
menu_numpad_es: 'teclado numérico',
menu_new_contact_es: 'Contacto Nuevo',
menu_mute_video_es: 'solo audio',
menu_mute_es: 'Silencio',
menu_multilinecall_es: 'Nueva llamada',
menu_message_es: 'Mensaje',
menu_lastcalldetails_es: 'Detalles de Última Llamada',
menu_integration_es: 'Integración',
menu_int_outlook_es: 'Complemento de Outlook',
menu_int_chrome_es: 'Complemento de Chrome',
menu_import_skype_es: 'Importar desde Skype',
menu_import_outlook_es: 'Importar desde Outlook',
menu_import_list_es: 'Importar contactos',
menu_import_google_es: 'Importar desde Google',
menu_import_file_es: 'Importar desde archivo (restaurar)',
menu_import_android_es: 'Importar desde un teléfono Android',
menu_ignore_es: 'Omitir',
menu_hold_es: 'Espera',
menu_help_es: 'Ayuda',
menu_groupchat_es: 'agregar personas (chat grupal)',
menu_folders_data_es: 'Mostrar directorio de datos',
menu_folders_bin_es: 'Mostrar directorio de contenedor',
menu_folders_es: 'Carpetas',
menu_filterct_es: 'Filtrar contactos',
menu_filter_es: 'Filtro',
menu_export_file_es: 'Exportar a archivo (copia de seguridad)',
menu_exit_videomode_es: 'Salir del modo de video',
menu_exit_es: 'Salir',
menu_editcontact_es: 'Editar contacto',
menu_deletecontact_es: 'Borrar contacto',
menu_delallct_es: 'Eliminar todos los contactos',
menu_ct_unsetfavorite_es: 'Eliminar de favoritos',
menu_ct_setfavorite_es: 'Establecer como favorito',
menu_createcontact_es: 'Guardar contacto',
menu_copy_es: 'Copiar',
menu_confrooms_es: 'llamada en grupo',
menu_conference_es: 'llamada en grupo',
menu_close_es: 'Cerrar',
menu_clearsettings_es: 'Borrar configuración',
menu_clearall_es: 'Borrar todo',
menu_callpickup_es: 'captura de llamadas',
menu_callpark_es: 'Estacionamiento de llamadas',
menu_callforward_es: 'Desviar llamada',
menu_call_access_es: 'Número de acceso en llamada',
menu_call_es: 'Llamada',
menu_block_contact_es: 'Bloquear contacto',
menu_audiodeviceshow_es: 'Dispositivos',
menu_audiodevicehide_es: 'Ocultar dispositivo de audio',
menu_accept_hold_es: 'Mantener antiguo Aceptar nuevo',
menu_accept_end_es: 'Finalizar antiguo Aceptar nuevo',
mediaencryption__srtp_es: 'SRTP',
mediaencryption__no_es: 'No',
mediaencryption__auto_es: 'Auto',
me_es: 'Yo',
mac_app_es: 'No hay motores disponibles en su entorno. Póngase en contacto con su proveedor de servicios.',
logview_title_es: 'Registros',
logview_msg_es: 'Es posible que la página no esté disponible durante unos segundos. Vuelva a cargar la página si no pasa nada.',
logview_help_es: 'Copie el contenido de la ventana de registros y envíelo por correo electrónico a:',
log_email_es: 'Su dirección de correo electrónico (útil para cualquier soporte técnico).',
log_description_es: 'Describa el problema brevemente.',
log_desc_error_es: '¡No enviado! La descripción es obligatoria.',
loading_es: 'Cargando..',
line_title_es: 'Línea',
license_key_es: 'Clave de Licencia',
jnotsupported_es: 'Chrome no es compatible con Java, use otro navegador',
jittersize__small_es: 'Pequeño',
jittersize__normal_es: 'Normal',
jittersize__no_es: 'No jitter',
jittersize__max_es: 'Máximo',
jittersize__esmall_es: 'Muy pequeño',
jittersize__ebig_es: 'Muy Grande',
jittersize__big_es: 'Grande',
java_install_title_es: 'Descargar e instalar Java',
java_install_es: 'haga clic en Aceptar para comenzar a descargar Java. <br>Vuelva a iniciar sesión una vez que haya terminado de instalarlo.',
java_freeze_ff_es: 'después de haber aceptado "Ejecutar esta aplicación",\nHaga clic en Aceptar para continuar',
interconnect_conf_es: 'Llamadas interconectadas en conferencia',
interconnect_es: 'Interconectar llamadas.',
install_java_es: 'se requiere Java: https://java.com/download/',
initiate_conference_es: 'Iniciar conferencia',
initiate_callforward_es: 'Iniciar desvío de llamada',
initiate_call_transfer_es: 'Iniciar transferencia de llamada',
initiate_call_forward_es: 'Iniciar desvío de llamada',
initializing_es: 'Inicializando',
incomingcallpopup__yes_es: 'Si',
incomingcallpopup__no_es: 'No',
incomingcallpopup__auto_es: 'Auto (mostrar solo si la ventana del navegador no está en primer plano/enfocada)',
incomingcallpopup__always_es: 'Forzar siempre desde todos los motores',
in_hold_es: '(Pausa)',
importonlywithnum__yes_es: 'Sí (importar solo usuarios con número de teléfono)',
importonlywithnum__no_es: 'No (importar todos los usuarios incluso sin un número de teléfono válido)',
ie_update_es: 'esta aplicación requiere una versión superior de Internet Explorer. ¿Quieres descargar y actualizar?',
home_es: 'Casa',
holdtype__otherparty_es: 'Otra parte en espera',
holdtype__notused_es: 'No utilizado',
holdtype__no_es: 'No',
holdtype__never_es: 'nunca retener',
holdtype__hold_es: 'Espera',
holdtype__both_es: 'Ambos en espera',
holdtype__auto_es: 'Auto',
hold_released_es: 'Hold released',
hint_voicemail_es: 'Buzón voz',
hint_transfer_es: 'Transferir llamada',
hint_status_es: 'eventos y mensajes de estado',
hint_speedtest_es: 'pruebe el ancho de banda de su conexión a Internet, la pérdida de paquetes y la latencia',
hint_speaker_es: 'Altavoz activado/desactivado',
hint_smiley_es: 'Insertar emoticón',
hint_settlogin_es: 'Guardar configuración e iniciar sesión',
hint_setprofpic_es: 'Establecer foto de perfil',
hint_sendmsg_es: 'Enviar mensaje',
hint_removephone_es: 'Eliminar teléfono',
hint_reject_new_es: 'Rechazar la nueva llamada entrante',
hint_reject_es: 'Rechazar llamada',
hint_recents_es: 'Acciones',
hint_quickcall_es: 'llamada rápida',
hint_phone_number_es: 'ingrese aquí el número de teléfono, el nombre de usuario de la cuenta SIP o el URI SIP',
hint_page_es: 'página seleccionada actual',
hint_numpad_es: 'teclado numérico/teclado de marcación',
hint_notif_clear_es: 'borrar esta notificación',
hint_mute_es: 'silenciar/no silenciar',
hint_more_es: 'Más',
hint_message_es: 'Mensaje',
hint_menu_es: 'Menú',
hint_integration_es: 'agregue la funcionalidad de hacer clic para llamar al convertir números en enlaces en los que se puede hacer clic',
hint_int_outlook_es: 'Instale el complemento de clic para llamar de Outlook',
hint_int_chrome_es: 'instalar el complemento de clic para llamar de Chrome',
hint_hold_es: 'Retener/Recargar',
hint_hangup_es: 'colgar llamada',
hint_folders_data_es: 'abrir el directorio de datos de la aplicación',
hint_folders_bin_es: 'Abrir directorio de aplicaciones',
hint_folders_es: 'Mostrar carpetas de aplicaciones',
hint_filetranf_es: 'Enviar archivo',
hint_encicon_es: 'Cifrado',
hint_dialpad_dtmf_es: 'Enviar DTMF',
hint_dialpad_es: 'Teclado',
hint_curr_user_es: 'nombre de usuario de la cuenta',
hint_contacts_es: 'contactos',
hint_conference_es: 'Añadir a la llamada en Grupo',
hint_closecall_es: 'Cerrar llamada',
hint_choosect_es: 'Elegir contacto',
hint_callstatus_es: 'estado de llamadas y mensajes de eventos',
hint_callhistory_es: 'Historial de Llamadas',
hint_callforward_es: 'Desviar llamada',
hint_called_es: 'Llamante/parte llamada',
hint_callduration_es: 'duración de la llamada',
hint_btnnewuser_es: 'Crear Usuario Nuevo',
hint_btnback_es: 'Volver a la página anterior',
hint_btn_call_es: 'Iniciar llamada',
hint_addphone_es: 'Agregar teléfono',
hint_accept_hold_es: 'poner la llamada anterior en espera y aceptar la nueva',
hint_accept_end_es: 'finalizar la llamada anterior y aceptar la nueva',
hint_accept_es: 'Aceptar llamada',
hide_search_es: 'Ocultar búsqueda',
help_stoplog_es: 'Dejar de guardar registros',
help_startlog_es: 'Comenzar a guardar registros',
help_sendlog_es: 'Ver registros/Enviar a soporte',
help_report_es: 'Reportar un problema',
help_rate_es: 'Calificar Mizu Webphone',
help_provider_es: 'Buscar un proveedor VoIP',
help_proversion_es: 'Licencia',
help_logwindow_es: 'Registros',
help_loging_es: 'Registros (rastreo)',
help_license_es: 'Contrato de Licencia',
help_help_es: 'Ayuda',
help_enablelog_es: 'Habilitar registros',
help_about_es: 'Sobre',
help_es: 'Ayuda',
hardwaremedia__yes_es: 'Si',
hardwaremedia__no_es: 'No',
hardwaremedia__auto_es: 'Auto',
goto_es: 'Ir a',
go_back_btn_txt_es: 'Volver',
gc_message2_es: 'se unió a la conversación',
gc_message_es: 'Estás en un chat grupal con',
ftrnasf_status_waiting_es: 'Esperando compañero...',
ftrnasf_status_processing_es: 'Procesando...',
ftrnasf_status_delivered_es: 'Entregado.',
forward_title_es: 'Desviar llamada',
forgotpassword_a_es: '¿Olvidó su contraseña?',
fitransf_succeded_es: 'Enviado con éxito',
fitransf_failed_es: '¡Elija un archivo para enviar primero!',
fitransf_chat_es: 'le envió un archivo',
filters_title_es: 'Reglas',
filters_add_rule_es: 'Añadir regla',
filters_add_label_es: 'agregar reglas',
filter_warning_es: 'Al menos se debe ingresar el campo "Comenzar con" o "Reemplazar con".',
filter_start_es: 'Cuando el número empieza por',
filter_replace_es: 'reemplazar con',
filter_minlen_es: 'longitud mínima',
filter_maxlen_es: 'longitud máxima',
filter_edit_hint_es: 'Editar regla',
filter_delete_hint_es: 'Eliminar regla',
filetransfer_nr_es: 'Sip URI o nombre de usuario',
filetransf_title_es: 'Enviar archivo',
filetransf_err_es: 'ingrese el destino primero.',
fcm_perm_message_es: 'se deniega el permiso para las notificaciones automáticas',
fax_work_es: 'Fax Trabajo',
fax_home_es: 'Fax Casa',
favafone_new_es: 'Soy nuevo en Favafone',
error_noserver_es: 'la dirección del servidor no está configurada.',
err_nocallinprogress2_es: 'No hay llamadas entrantes al intentar aceptar',
err_nocallinprogress_es: 'ninguna llamada en curso',
err_msg_9_es: 'Introduzca contraseña.',
err_msg_8_es: 'Introduzca un nombre de usuario.',
err_msg_7_es: 'No hay mensajes para borrar',
err_msg_6_es: 'Dirección invalida.',
err_msg_5_es: 'Numero de teléfono invalido.',
err_msg_4_es: 'número de teléfono, URI de SIP o nombre de usuario no válidos',
err_msg_3_es: 'ERROR, ingrese un número de teléfono o SIP URI o nombre de usuario',
err_msg_22_es: 'no se puede recuperar la configuración. Vuelva a intentarlo más tarde.',
err_msg_21_es: 'Ingrese su número de teléfono.',
err_msg_20_es: 'Dirección invalida.',
err_msg_2_es: 'Contraseña invalida.',
err_msg_19_es: 'Numero de teléfono invalido.',
err_msg_18_es: 'nombre invalido.',
err_msg_17_es: 'Longitud del nombre completo debe ser al menos de',
err_msg_16_es: 'Contraseña invalida.',
err_msg_15_es: 'Longitud de la contraseña debe ser al menos de',
err_msg_14_es: 'Nombre de usuario invalido.',
err_msg_13_es: 'Longitud del nombre de usuario debe ser al menos de',
err_msg_12_es: 'Introduzca dirección de correo valida.',
err_msg_11_es: 'Introduzca nombre completo.',
err_msg_10_es: 'Introduzca una dirección de correo valida.',
err_msg_1_es: 'Nombre de usuario invalido.',
err_flash_local_es: 'el motor Flash funcionará solo si se inicia desde un servidor web, no desde un sistema de archivos local',
enter_license_key_es: 'Introduzca la clave de licencia',
enablepush__yesgateway_es: 'Sí - Puerta de enlace',
enablepush__yesdirect_es: 'Sí - Directo',
enablepush__yesauto_es: 'Sí - Detección automática',
enablepush__yes_es: 'Si',
enablepush__no_es: 'No',
enablepush__auto_es: 'Auto',
enableblf__no_es: 'No',
enableblf__must_es: 'Fuerza',
enableblf__auto_es: 'Auto',
enableblf__always_es: 'Siempre',
earlymedia__yes_es: 'Sí cuando SDP recibió',
earlymedia__reserved_es: 'Reservado',
earlymedia__null_packets_es: 'paquetes nulos solo cuando se recibe SDP',
earlymedia__no_es: 'No',
earlymedia__just_early_es: 'acaba de abrir el audio temprano',
earlymedia__auto_es: 'Automático (abrirá el audio antes si la banda ancha está habilitada para verificar si es compatible)',
earlymedia__always_force_es: 'Siempre forzado si',
duration_es: 'Duración de la llamada:',
dtmfmode_op_6_es: 'INFO + InBand',
dtmfmode_op_5_es: 'en banda (tonos de audio DTMF en la transmisión RTP)',
dtmfmode_op_4_es: 'NTE (Eventos telefónicos con nombre como se especifica en RFC2833 y RFC 4733)',
dtmfmode_op_3_es: 'INFO + NTE',
dtmfmode_op_2_es: 'Automático (suposición automática a partir de capacidades anunciadas por pares)',
dtmfmode_op_1_es: 'método SIP INFO',
dtmfmode_op_0_es: 'Deshabilitado',
dropsameoldcall__reqvideo_es: 'Sí cuando se solicita y video',
dropsameoldcall__requested_es: 'cuando se solicita (si se recibió el encabezado del sorbo)',
dropsameoldcall__no_es: 'No',
dropsameoldcall__forall_es: 'Sí, para todas las llamadas',
doublesendrtp__yes_es: 'Si',
doublesendrtp__no_es: 'No',
displaynotification__onevent_es: 'en evento',
displaynotification__never_es: 'Nunca',
displayname_login_es: 'Su nombre completo en el lado llamado',
disc_reason_es: 'motivo de desconexión',
disable_logs_es: 'deshabilitar registros',
dialpad_title_es: 'Llamada',
denoise__recording_es: 'solo para grabar',
denoise__disabled_es: 'Deshabilitado',
denoise__both_es: 'tanto para reproducción como para grabación',
denoise__auto_es: 'Invitado automático',
delete_text_es: 'Borrar',
delete_msg_alert_es: 'Todo el hilo será borrado.',
delete_all_msg_alert_es: 'se eliminarán todos los mensajes.',
defmute__speakers_only_es: 'Solo altavoces',
defmute__mic_only_es: 'Solo Micrófono',
defmute__both_es: 'Ambos',
ctlist_title_es: 'contactos',
ctdetails_title_es: 'Contacto',
ctdetails_btnback_txt_es: 'Todos los contactos',
ct_unsetfavorited_es: 'Eliminado de favoritos',
ct_sort_title_es: 'Ordenar contactos',
ct_sort_status_es: 'Por estado',
ct_sort_name_es: 'Por nombre',
ct_sort_importance_es: 'Por importancia',
ct_search_hint_es: 'Buscar Contactos',
ct_menu_error_es: 'este contacto no tiene números ni SIP URI',
ct_filter_title_es: 'Mostrar solo contactos',
ct_filter_online_es: 'en línea',
ct_filter_important_es: 'Importante',
ct_filter_all_es: 'Todas',
contact_saved_es: 'Contacto guardado',
contact_save_error_es: 'Error, el contacto no se puede guardar',
contact_phone_es: 'Nr Teléfono',
contact_no_nunber_es: 'ingrese un número de teléfono, nombre de usuario o SIP URI',
contact_name_es: 'Nombre',
contact_delete_msg_es: '¿Seguro que quiere borrar este contacto?',
contact_delete_all_msg_es: '¿Está seguro de que desea eliminar todos los contactos? <br>¡Esto eliminará permanentemente toda la lista de contactos!',
contact_alert_title_es: 'Elija tipo de teléfono',
connection_title_es: 'problema de conexión',
connection_msg_es: 'Red fuera de línea: ¡verifique su conexión!',
confroom_msg2_es: 'agregar personas a la conferencia',
confroom_msg1_es: 'el número de su sala de conferencias es',
confroom_inv_title_es: 'Invitar a la conferencia',
confroom_inv_msg_es: 'Está invitado a una conferencia telefónica por',
conferencetype__server_es: 'lado del servidor controlado por DTMF',
conferencetype__native_es: 'Nativo solo con mezclador rtp local',
conferencetype__disabled_es: 'Deshabilitado',
conferencetype__cr_ref_es: 'Salas de conferencias vía SIP REFER',
conferencetype__cr_msg_ref_es: 'salas de conferencias a través de SIP MESSAGE y REFER',
conferencetype__cr_msg_es: 'Salas de conferencias vía MENSAJE SIP',
conferencetype__auto_es: 'Auto',
conferencetype__3way_es: 'conferencia SIP de 3 vías',
conference_title_es: 'Añadir a la llamada en Grupo',
confdtmf_msg_es: 'agregar personas a la conferencia',
composing_es: 'está escribiendo',
codecframecount_auto_es: 'Auto',
clear_callhistory_msg_es: 'Confirmar borrado de historial de llamadas ?',
clear_callhistory_es: 'Borrar Historial de Llamadas',
chrome_local_webrtc_audio_es: 'WebRTC no tiene permiso para acceder a dispositivos de audio desde el sistema de archivos local en los navegadores Chrome y Opera. \nEl teléfono web debe estar alojado en un servidor web seguro (HTTPS) para poder realizar/recibir llamadas mediante WebRTC.',
chrome_local_alert_es: 'el motor WebRTC incorporado en el teléfono web no funcionará desde el sistema de archivos local en los navegadores Google Chrome u Opera (solo en HTTPS, desde servidores web con certificado SSL válido).\nEn estas circunstancias, el teléfono web se verá obligado a usar el NS u otros motores si están disponibles. Puede usar Firefox si desea probar el motor WebRTC del teléfono web cuando se inicia desde el sistema de archivos local.',
chrome_https_reload_es: 'para Chrome, Opera y Firefox versión 68 y superior, WebRTC solo funcionará desde http seguro (https). \n\n Haga clic en Aceptar para volver a cargar la página usando el proxy https de mizu.',
chrome_https_es: 'para Chrome, Opera y Firefox versión 68 y superior, recomendamos alojar el teléfono web en http seguro (https), de lo contrario, WebRTC no funcionará.',
chrome_ext_install_title_es: 'instalar la extensión de Chrome',
chrome_ext_install_es: 'Antes de usar Compartir pantalla, se debe instalar la extensión de Chrome del siguiente enlace.',
chrome_ext_enable_title_es: 'habilitar la extensión de Chrome',
chrome_ext_enable_es: 'haga clic en el enlace a continuación y habilite la extensión de Chrome Captura de pantalla',
choose_engine_title_single_engine_es: 'Haga clic para descargar/instalar',
choose_engine_title_es: 'Elegir motor',
chlist_title_es: 'Historial de Llamadas',
chfilter_out_es: 'Saliente',
chfilter_missed_es: 'Perdidas',
chfilter_in_es: 'Entrando',
chfilter_all_es: 'Todas',
chdetails_title_es: 'Información',
chdetails_btnback_txt_es: 'Historial de Llamadas',
chatsms__sms_only_es: 'Solo SMS',
chatsms__disable_es: 'deshabilitar los mensajes de texto entrantes',
chatsms__chat_only_es: 'Solo Chat',
chatsms__auto_guess_or_ask_es: 'Invitado automático',
chat_sms_title_es: 'Chat o SMS',
chat_nr_es: 'SIP URI, nombre de usuario o número',
chat_es: 'Mensaje de Chat',
changesptoring__start_media_disp_es: 'iniciar medios y mostrar el timbre',
changesptoring__start_media_es: 'Iniciar medios',
changesptoring__nothing_es: 'No hacer nada',
changesptoring__disp_ringing_es: 'mostrar el estado del timbre',
ch_outgoing_es: 'Llamada saliente',
ch_missed_es: 'Llamada perdida',
ch_incoming_es: 'Llamada entrante',
ch_delete_es: 'Borrar del historial de llamadas',
ce_webrtcnot_es: '(No recomendado)',
ce_usewebrtc_es: 'usar webrtc',
ce_use_es: 'seleccionado. Solo inicia sesión.',
ce_native_ios2_es: 'Puede descargar la aplicación desde aquí',
ce_native_ios_safari_es: 'Su navegador no es compatible con WebRTC. Utilice la aplicación nativa.',
ce_native_ios_not_safari_es: 'Su navegador no es compatible con WebRTC. Cambie al navegador Safari o use la aplicación nativa.',
ce_native_ios_es: 'Su navegador no es compatible con WebRTC.',
ce_native_android_es: 'Usar aplicación nativa',
ce_installnativeplugin_es: 'instala [NATIVE_PLUGIN] para disfrutar de la mejor experiencia',
ce_dontask_es: 'No volver a preguntar',
ce_browser_install_es: 'Instalar',
ce_browser_alternate_es: 'navegador alternativo',
ce_ask_user_es: 'Parece que el motor [MOTOR SELECCIONADO] no funciona. ¿Cambiar a [RECOMENDADO]?',
ce_alert_title_es: 'Instalar',
cb_callonnative_es: 'Llamada VoIP',
cb_callonmobile_es: 'Llamada móvil',
calls_es: 'llamadas perdidas',
callreceiver__noincoming_es: 'deshabilitar todas las llamadas entrantes',
callreceiver__enablewhilerunning_es: 'habilite las llamadas entrantes (mientras la aplicación se está ejecutando, sin escucha de fondo)',
callreceiver__enablebackgroud_es: 'habilitar también llamadas en segundo plano',
callreceiver__auto_es: 'Auto',
callhistory_es: 'Historial de Llamadas',
callforward_title_es: 'Desviar llamada',
callback_src_es: 'ingrese su número de teléfono móvil <br>(comenzando con el código de país)',
callback_es: 'Devolver Llamada',
call_from_es: 'Llamada perdida',
call_forward_warn_es: 'el desvío de llamadas funcionará solo si el par remoto tiene soporte para ello.',
btn_videocall_es: 'Videollamada',
btn_video_fullscreen_es: 'Pantalla completa',
btn_upgrade_es: 'Actualizar',
btn_transfer_es: 'transferir',
btn_smsverify_es: 'Verificar',
btn_sharescreen_es: 'Compartir',
btn_set_es: 'Establecer',
btn_send_es: 'Enviar',
btn_save_to_contacts_dontask_es: 'No volver a preguntar',
btn_save_to_contacts_2_es: 'Sí, añadir a un contacto existente',
btn_save_to_contacts_1_es: 'Sí, crear un contacto nuevo',
btn_save_es: 'Guardar',
btn_revert_es: 'Revertir',
btn_reject_es: 'Rechazar',
btn_quicktransf_es: 'Rápido',
btn_quickcall_es: 'Llamada',
btn_qrcode_es: 'inicio de sesión con código QR',
btn_ok_es: 'OK',
btn_new_message_es: 'Nuevo mensaje',
btn_login_es: 'Iniciar sesión',
btn_hangup_es: 'Colgar',
btn_download_es: 'Descargar',
btn_decline_es: 'Rechazar',
btn_create_es: 'Crear',
btn_close_es: 'Cerrar',
btn_cancel_es: 'Cancelar',
btn_audio_device_es: 'Dispositivos de audio',
btn_attendedtransf_short_es: 'Asistió',
btn_attendedtransf_es: 'transferencia atendida',
btn_activate_es: 'Activar',
btn_accept_es: 'Aceptar',
barcode_success_es: 'código QR leído con éxito',
autoprov_restart_es: 'Aplicando configuración...',
autoprov_loading_es: 'Recuperando configuración...',
automute__outgoing_es: 'Activo en llamada saliente',
automute__other_line_es: 'Activo hacer click en otro botón de línea',
automute__no_es: 'No (defecto)',
automute__incoming_es: 'Auto-respuesta, reenvío o ignorar',
automute__both_es: 'Activo en llamadas entrantes y salientes',
autoignore__silently_es: 'Ignorar en silencio',
autoignore__reject_es: 'Rechazar',
autoignore__dont_es: 'No ignorar',
autohold__outgoing_es: 'Activo en llamada saliente',
autohold__other_line_es: 'Activo hacer click en otro botón de línea',
autohold__no_es: 'No (defecto)',
autohold__incoming_es: 'Auto-respuesta, reenvío o ignorar',
autohold__both_es: 'Activo en llamadas entrantes y salientes',
audio_title_es: 'dispositivo de audio',
audio_ring_es: 'Anillo',
audio_rec_es: 'Altavoz',
audio_mic_es: 'Micrófono',
audio_all_devices_es: 'Todas',
audio_agc_es: 'AGC',
audio_aec_es: 'AEC',
attendedtransf_hint_es: 'llamar, luego colgar la llamada',
attended_transfer_title_es: 'transferencia atendida',
app_en_warning_short_es: 'el navegador no tiene soporte de VoIP integrado o de complemento.',
app_en_warning_es: 'Su navegador no tiene ningún soporte de VoIP incorporado o de complemento. <br>Iniciando cliente de VoIP nativo...',
app_en_message3_es: 'no se puede acceder a su servidor VoIP a través de WebRTC o no está configurado. ¿Iniciar aplicación nativa?',
app_en_message2_es: 'VoIP no es compatible con su navegador. ¿Lanzar aplicación nativa?',
app_en_message_es: 'VoIP no es compatible con su navegador. Lanzará la aplicación nativa. (este mensaje no se mostrará en la versión de producción).',
androidspeaker__ignore_es: 'No cambiar',
androidspeaker__guess_es: 'Invitado automático',
androidspeaker__def_es: 'Por defecto',
androidspeaker__before_fcall_es: 'apagar el altavoz antes de la primera llamada',
androidspeaker__atstart_es: 'apagar el altavoz al inicio',
androidspeaker__after_fcall_es: 'apagar el altavoz después de la primera llamada',
alwaysallowlowcodec__never_es: 'Nunca',
alwaysallowlowcodec__auto_es: 'Auto',
alwaysallowlowcodec__always_es: 'Siempre',
allowmedia_title_es: 'Acceso a medios',
allowmedia_general_es: 'necesita acceso a su micrófono.<br>Para otorgar acceso, haga clic en el icono de sonido/webrtc/micrófono/cámara/rojo en su navegador y seleccione Permitir o Compartir, luego vuelva a realizar la llamada.',
all_demo_msg_es: 'Nota: estos mensajes se muestran solo en la versión de demostración, en la versión final, estas situaciones se manejan automáticamente',
agc__guess_es: 'Guess',
agc__for_redcording_es: 'solo para grabar',
agc__disabled_es: 'Deshabilitado',
agc__both_for_recording_and_playback_es: 'tanto para reproducción como para grabación',
aec_software_es: 'Software',
aec_none_es: 'Ninguno',
aec_native_es: 'Nativo',
aec_fast_es: 'Rápido',
aec_decrease_volume_es: 'Bajar Volumen',
aec_auto_es: 'Auto',
addeditct_title_new_es: 'Contacto Nuevo',
addeditct_title_edit_es: 'Editar contacto',
addeditct_label_website_es: 'Sitio web',
addeditct_label_notes_es: 'Notas',
addeditct_label_email_es: 'Email',
addeditct_label_address_es: 'Dirección',
addeditct_hint_adddetails_es: 'Agregar campo adicional',
addeditct_addfield_es: 'Agregar campo',
addaccount_title_es: 'Añadir cuenta.',
addaccount_msg_es: 'Complete los siguientes detalles para crear una nueva cuenta',
addacc_user_es: 'Usuario',
addacc_server_es: 'dirección del servidor',
addacc_password_es: 'Clave',
addacc_ival_es: 'Intervalo de registro',
addacc_invalid_es: 'no válido',
add_to_home_title_es: 'Crear acceso directo',
add_to_home_msg_es: 'puede crear un acceso directo en su pantalla de inicio a [MARCA]. Toca el ícono de Menú/Barra en la esquina superior derecha de tu navegador, luego toca \"Agregar a la pantalla de inicio\"',
add_account_es: 'Añadir cuenta.',
active_account_es: 'Cuenta inactiva:',
activated_es: 'Licencia Pro activada.',
accounts_title_es: 'Cuentas',
accounts_remove_msg_es: '¿Está seguro de que desea eliminar esta cuenta?',
accounts_remove_hint_es: 'Borrar cuenta',
accounts_main_hint_es: 'Establecer como cuenta principal',
accounts_instructions2_es: 'la cuenta seleccionada será la cuenta principal para las llamadas salientes. Las llamadas entrantes se pueden recibir en todas las cuentas.',
accounts_instructions1_es: 'administrar cuentas o establecer una cuenta principal.',
accounts_hint_user_es: 'cuenta VoIP del usuario',
accounts_hint_server_es: 'dirección IP del Servidor SIP o nombre de dominio  [:puerto]',
accounts_hint_regival_es: '(Re)registrar intervalo de tiempo en segundos',
accounts_hint_realm_es: 'parámetro opcional para configurar el reino SIP si no es el mismo con la dirección del servidor o el dominio',
accounts_hint_proxy_es: 'Dirección del proxy saliente',
accounts_hint_password_es: 'Contraseña de la cuenta VoIP',
accounts_hint_displayname_es: 'Su nombre completo se mostrará en el lado llamado',
accounts_hint_callerid_es: 'Podría establecerse un usuario distinto para utilizarlo en una pantalla',
accounts_endis_hint_es: 'habilitar/deshabilitar cuenta',
accounts_add_hint_es: 'Agregar nueva cuenta',
ac_showadvanced_es: 'muestra la configuración de inicio de sesión avanzada',
ac_hideadvanced_es: 'ocultar la configuración de inicio de sesión avanzada',
about_support_es: 'Soporte',
about_license_es: 'Contrato de Licencia',
about_homepage_es: 'Página de inicio',
about_copyright2_es: 'Todos los derechos reservados.',
about_copyright_es: 'Derechos de autor ©',
...
function setlang(lan)
{
    ...
    //lang = TrimEx(lan.toLowerCase());

    lang = lan.toLowerCase();
    //lang = TrimEx(lang); //TrimEx is not defined here!
    ...
    if(lang.length > 0)
    {
       if(lang.length > 2)
       {
            if(lang.indexOf('-') > 0) langshort = lang.substr(0,lan.indexOf('-'));
            else if(lang.indexOf('_') > 0) langshort = lang.substr(0,lan.indexOf('_'));

            //if(langshort.length > 0) langshort = '_' + langshort.toLowerCase();
            if(langshort.length > 0) {
                //langshort = TrimEx(langshort);
                if(langshort.length > 0)
                {
                    if (
